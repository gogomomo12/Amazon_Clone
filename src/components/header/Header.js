      ...
      <div className="w-full bg-amazon_blue text-white px-4 py-3 flex md:justify-between items-center gap-2 md:gap-4 lgl:gap-2 xl:gap-4">
        ...
        <div className="hidden md:inline-flex headerHover">
          ...
          <p className="flex flex-col text-xs text-lightText font-light">
            ...
            Philippines
            </span> {/* // TODO: CHANGE THIS SPAN IN TO FUNCTION (WHATEVER COUNTRY) */}
          </p>
        </div>
        ...
        <Link to="/cart">
          <div className="flex items-start justify-center headerHover relative">
            ...
            <span className="absolute text-xs -top-1 left-6 w-4 font-semibold p-1 h-4 bg-[#f3a847] text-amazon_blue rounded-full flex justify-center items-center">
        ...
        {userInfo && (
          ...
          </div> // TODO: MAKE THIS A FUNCTION (APPEAR IF SIGN-IN)
        )}
