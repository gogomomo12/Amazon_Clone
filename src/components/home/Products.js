...
const Products = () => {
  ...
  return (
    <div className="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-10 xl:gap-4 px-4"> {/* This div is for FORMAT GAPS OF CARDS */}
      {productsData.map((item) => (
        ...
        > {/* //! This div is the CARD */}
          ...
          <div className="w-full h-auto flex items-center justify-center relative group"> {/* //! This div is for IMAGE ONLY */}
            <img
          ...
          <div className="px-4 bg-white flex flex-col gap-1 z-10"> {/* This div is for TEXT INFO ONLY */}
            ...
            <div>
              ...
              <div className="text-yellow-500 flex">
                ...
                <StarIcon />
                <StarIcon />
              </div> {/* //! This div CHANGE IT TO FUNCTION */}
            </div>
            <button
              onClick={() =>
                dispatch(
